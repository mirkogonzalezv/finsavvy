...
extension UserLocalQueryFilter
  ...
  QueryBuilder<UserLocal, UserLocal, QAfterFilterCondition> lastLoginIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<UserLocal, UserLocal, QAfterFilterCondition> lastLoginEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'lastLogin',
  ...
  QueryBuilder<UserLocal, UserLocal, QAfterFilterCondition> lastLoginLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<UserLocal, UserLocal, QAfterFilterCondition> lastLoginBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<UserLocal, UserLocal, QAfterFilterCondition> uidIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'uid',
      ));
  ...
  QueryBuilder<UserLocal, UserLocal, QAfterFilterCondition> uidIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'uid',
      ));
...
extension UserLocalQuerySortBy on QueryBuilder<UserLocal, UserLocal, QSortBy> {
  ...
  QueryBuilder<UserLocal, UserLocal, QAfterSortBy> sortByLastLogin() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastLogin', Sort.asc);
    });
  }

  QueryBuilder<UserLocal, UserLocal, QAfterSortBy> sortByLastLoginDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension UserLocalQuerySortThenBy
  ...
  QueryBuilder<UserLocal, UserLocal, QAfterSortBy> thenByLastLogin() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastLogin', Sort.asc);
    });
  }

  QueryBuilder<UserLocal, UserLocal, QAfterSortBy> thenByLastLoginDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastLogin', Sort.desc);
    });
  }
...
extension UserLocalQueryWhereDistinct
  ...
  QueryBuilder<UserLocal, UserLocal, QDistinct> distinctByLastLogin() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'lastLogin');
    });
  }

  QueryBuilder<UserLocal, UserLocal, QDistinct> distinctByUid(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension UserLocalQueryProperty
  ...
  QueryBuilder<UserLocal, DateTime?, QQueryOperations> lastLoginProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'lastLogin');
    });
  }

  QueryBuilder<UserLocal, String?, QQueryOperations> uidProperty() {
    return QueryBuilder.apply(this, (query) {
